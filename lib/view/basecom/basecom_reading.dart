...
class BasecomReading extends BaseWidget<BaseComReadingVM> {
  const BasecomReading({super.key});

  @override
  Widget buildUI(BuildContext context, BaseComReadingVM viewModel) {
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  isExpanded: true,
                  validator: (value){
                    return value == null ? "Select Basecom Meter":null;
                  },
                  ...
                  style: GoogleFonts.poppins(
                      ...
                      color: colorBlack),
                  items: viewModel.bescomMeter.map((value)
                  {
                ...
                ListView.builder(
                    shrinkWrap:true,
                    itemCount:viewModel.bescomReadings.length,
                    physics:const ScrollPhysics(),
                    scrollDirection:Axis.vertical,
                    itemBuilder: (context, i) {
                      var category = viewModel.bescomReadings[i];
                      return  Padding(
